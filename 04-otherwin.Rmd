...
```{r Packages_1, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp4/Packages_1.png")
```
...
```{r Packages_2, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp4/Packages_2.png")
```
...
```{r Packages_3, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp4/Packages_3.png")
```
...
```{r Packages_4, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp4/Packages_4.png")
```
...
```{r Packages_5, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp4/Packages_5.png")
```
