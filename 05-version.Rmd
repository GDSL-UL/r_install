...
```{r wv1, fig.align = 'center', echo = FALSE}
...
```{r wv2, fig.align = 'center', echo = FALSE}
...
```{r arch1, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp5/Picture7.png")
```
...
```{r arch2, fig.align = 'center', echo = FALSE}
knitr::include_graphics("figs/chp5/Picture8.png")
```
